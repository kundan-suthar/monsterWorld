...
Command: npx gltfjsx@6.5.3 public/models/Dragon_Evolved.gltf public/models/Dragon_Evolved.gltf -o src/components/Dragon_Evolved.jsx -r public 
*/
...
export function Dragon_Evolved({ hovered, ...props }) {
  ...
  console.log(actions);
  useEffect(() => {
    let anim = hovered ? "Headbutt" : "Flying_Idle"
